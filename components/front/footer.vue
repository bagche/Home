      ...
      <div class="-mx-4 flex flex-wrap">
        ...
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
          <div class="mb-10 w-full">
            <nuxt-link
              to="/"
              class="text-4xl font-bold block w-full py-5 text-white"
            >
              Bagche
            </nuxt-link>
            <p class="mb-8 max-w-[270px] text-base text-gray-400">
              Empowering creators and businesses with our no-code platform,
              AI-powered tools, and seamless integrations.
            </p>
            <div class="-mx-3 flex items-center">
              <a
                href="https://www.facebook.com/yourcompany"
                class="px-3 text-gray-400 hover:text-white"
              >
                <!-- Facebook Icon SVG -->
                <svg
                  width="22"
              ...
              >
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <!-- Add Instagram SVG content here -->
                </svg>
              </a>
              <a
        ...
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
          <div class="mb-10 w-full">
            <h4 class="mb-9 text-lg font-semibold text-white">Products</h4>
            <ul>
              <li>
                <a
        ...
        <div class="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
          <div class="mb-10 w-full">
            <h4 class="mb-9 text-lg font-semibold text-white">Stay Updated</h4>
