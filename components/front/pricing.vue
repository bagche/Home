        ...
        <div class="w-full px-4">
          <div class="mx-auto mb-[60px] max-w-[510px] text-center">
            ...
            <p class="text-base text-body-color dark:text-dark-6">
              Get started for free and scale up as your business grows. Our
              flexible plans are designed to meet the needs of individuals,
              startups, and enterprises.
            </p>
          </div>
        </div>
      </div>
      <div class="-mx-4 grid grid-cols-3 gap-4 auto-rows-fr">
        <!-- Free Plan -->
        <div class="w-full px-4">
          <div
